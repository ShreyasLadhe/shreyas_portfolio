  ...
  return (
    ...
    >
      ...
      <p className="flex items-center justify-center gap-3 relative z-10">
        ...
        View Credly Profile - AWS
      </p>
    </motion.button>
  );
};

export default RedirectCredlyButtonAWS; 